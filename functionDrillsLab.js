...
//CODE HERE
function buyFrogs(numGold){
  let numFrogs = numGold / 3;
  console.log(`You can buy ${numFrogs} frogs`)
  return numFrogs;
}
let totalFrogs = buyFrogs(15);
...
//CODE HERE
function buyFrogs2(numGold){
  let numFrogs = numGold / 3;
  numFrogs = Math.floor(numFrogs);
  console.log(`You can buy ${numFrogs} frogs`)
  return numFrogs;
}
let totalFrogs2 = buyFrogs2(14);
